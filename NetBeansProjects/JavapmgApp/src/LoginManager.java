...
public class LoginManager extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Managers Login");
    ...
    private void jButtonLogin1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonLogin1ActionPerformed
        ...
        try {
            ...
            if(rs.next()){
                this.dispose();
                 showSoldDrugsForm shSDF = new showSoldDrugsForm();
                shSDF.setVisible(true);
                shSDF.pack();
                shSDF.setLocationRelativeTo(null);
                shSDF.setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
    ...
    private void jLabelCreateAccountMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabelCreateAccountMouseClicked
       ...
       AddMf.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
        this.dispose();
