 ...
 * @author Life
 */
public class AddManagerForm extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("New Manager Account");
        ...
        jButtonAddManager.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jButtonAddManager.setText("Create");
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        .addComponent(jButtonAddManager, javax.swing.GroupLayout.PREFERRED_SIZE, 82, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(119, 119, 119))))
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGap(210, 210, 210)
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(jButtonAddManager, javax.swing.GroupLayout.PREFERRED_SIZE, 35, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(75, 75, 75)
                .addComponent(jLabelAlreadyHaveAccount)
                .addGap(27, 27, 27))
        );
    ...
    private void jButtonAddManagerActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonAddManagerActionPerformed
        ...
        if(verifData()) {
            ...
            if(isUsenameExist(jTextField_Username.getText())){
             ...
             pst.insertUpdateDeleteManager('i',null, fname, lname, sex, bdate, phone, address,email,username,String.valueOf(jPasswordField2.getPassword()));
            } catch (Exception ex) {
                Logger.getLogger(AddManagerForm.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
...
public boolean isUsenameExist(String un){
        ...
        try {
            ps = con.prepareStatement("SELECT * FROM `manager` WHERE `username`=?");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AddManagerForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AddManagerForm().setVisible(true);
            }
        });
    }
